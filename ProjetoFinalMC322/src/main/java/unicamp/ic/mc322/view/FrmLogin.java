...
import unicamp.ic.mc322.view.admin.FrmListaEmpresas;
...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void btnentrarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnentrarActionPerformed
        for (Funcionario f : Main.usuarios) {
            if (txtemail.getText().equals(f.getCpf()) && String.valueOf(txtsenha.getPassword()).equals(f.getSenha())) {
                // Usuario logou
                if (f.getCargo().equals("Administrador") || f.getCargo().equals("Dono")) {
                    FrmListaEmpresas tela = new FrmListaEmpresas(f);
                    tela.setVisible(true);
                    this.dispose();
                    return;
                } else {
                    FrmMenu menu = new FrmMenu(f);
