...
public class FrmConsultaClientePJ extends javax.swing.JFrame {
     ...
     */
    public FrmConsultaClientePJ(Funcionario funcionarioLogado) {
        initComponents();
        ...
        if (lista != null)
            for (Cliente c : lista) {
                if (c instanceof ClientePJ) {
                    Object[] novaLinha = { ((ClientePJ) c).getCadastroPessoa(), ((ClientePJ) c).getNome(),
                            ((ClientePJ) c).getDataFundacao(), ((ClientePJ) c).getQntFuncionarios()
                    }; // Substitua
                       // pelos
                       // dados
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmConsultaClientePJ(new Gerente(null, null, null, null, null, null, null)).setVisible(true);
            }
        });
    }
